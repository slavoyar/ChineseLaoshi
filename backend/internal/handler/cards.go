...
func (h *CardHandler) ListByGroup(w http.ResponseWriter, r *http.Request) {
	...
	cards, err := h.service.GetCardsByGroupID(r.Context(), groupID)
	if err != nil {
...
func (h *CardHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	card, err := h.service.CreateCard(r.Context(), body)
	if err != nil {
		mapHandlerError(w, err)
		return
	}
...
func (h *CardHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.service.UpdateCard(r.Context(), body); err != nil {
		mapHandlerError(w, err)
		return
	}
...
func (h *CardHandler) GetWriteCards(w http.ResponseWriter, r *http.Request) {
	...
	cards, err := h.service.GetWriteCards(r.Context(), body, user.ID)
	if err != nil {
		mapHandlerError(w, err)
		return
	}
...
func (h *CardHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.service.DeleteCard(r.Context(), cardID); err != nil {
		mapHandlerError(w, err)
		return
	}
	w.WriteHeader(http.StatusOK)
