...
import layout from '../inner-layout.module.css';
...
export default function AboutPage() {
  return (
    <InnerLayout
      ...
      nav={
        <a className={layout.navLink} href="/app" data-i18n="backToApp" data-testid="about-back-link">
          Back to app
        </a>
      }
    >
      ...
      <ul>
        <li>
          <strong className={styles.strong} data-i18n="handwritingFeatureLead">
            Handwriting practice
          </strong>
          <span data-i18n="handwritingFeatureBody">
            {' — write Chinese characters with touch or mouse and get stroke feedback.'}
          </span>
        </li>
        <li>
          <strong className={styles.strong} data-i18n="translationFeatureLead">
            Translation drills
          </strong>
          <span data-i18n="translationFeatureBody">
            {' — review meanings and strengthen recall with flashcard study modes.'}
          </span>
        </li>
        <li>
          <strong className={styles.strong} data-i18n="customGroupsFeatureLead">
            Custom word groups
          </strong>
          <span data-i18n="customGroupsFeatureBody">
            {' — build your own card decks with characters, pinyin, and translations.'}
          </span>
        </li>
      </ul>
